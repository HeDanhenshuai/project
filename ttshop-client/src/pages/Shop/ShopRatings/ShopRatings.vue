        ...
        <ul>
          <li class="rating-item" v-for="(rating, index) in filterRatings" :key="index">
            ...
            <div class="content">
              ...
              <div class="recommend">
                <span class="iconfont" :class="rating.rateType===0 ? 'icon-dianzan' : 'icon-zan'"></span>
...
export default {
  ...
  computed: {
    ...
    filterRatings() {
      // 得到相关的数据(从vuex中得到相关的数据)
      let {ratings, onlyShowText, selectType} = this
      // const ratings=this.ratings
      // const onlyShowText=this.onlyShowText
